    ...
    if (oneVector) {
        return (
            <div className={styles[styleButton]}
                ...
                <div>
                    <svg className={styles[`${styleButton}_vector1`]} xmlns="http://www.w3.org/2000/svg" width="17"
                    ...
                    <svg className={styles[`${styleButton}_vector2`]} xmlns="http://www.w3.org/2000/svg" width="7"
